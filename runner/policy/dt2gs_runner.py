...
from base_policy.algorithms.dt2gs.dt2gs_policy import dt2gsPolicy as Policy
from base_policy.algorithms.dt2gs.dt2gs_trainer import dt2gsTrainer as Trainer

class dt2gsETERunner(Runner):
    """
    Base class for training recurrent policies for DT2GS.
    :param config: (dict) Config dictionary containing parameters for training.
    """
    def __init__(self, config):
        super(dt2gsETERunner, self).__init__(config)
