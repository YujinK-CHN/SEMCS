...
def get_common_config(parser):
    ...
    parser.add_argument("--algorithm_name", type=str, default='mcs', choices=["mcs", "dt2gs", "sft", "mappo", "sesil", "sebal", "newskill", "hmasd", "ippo", "mat", "tgcnet", "maic", "scvd"])
    parser.add_argument("--experiment_name", type=str, default="check", help="an identifier to distinguish different experiment.")
    parser.add_argument("--seed", type=int, default=1, help="Random seed for numpy/torch")
    parser.add_argument("--cuda", action='store_false', default=True, help="by default True, will use GPU to train; or else will use CPU;")
    parser.add_argument("--gpus", type=str, default=None, help="comma-separated GPU ids to use (e.g. '0,1,2'). If not set, all GPUs are available.")
