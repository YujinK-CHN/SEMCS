...
def get_SESiL_config(parser, env_name):
    ...
    parser.add_argument("--evo_pretrain_budget", type=int, default=0, help="extra steps for pretraining the initial population before evolution (0=no pretraining)")
    parser.add_argument("--evo_gen_budget", type=int, default=0, help="fixed training budget per generation in env steps (0=auto: split remaining budget evenly)")
